...
function loadProject(id: number) {
    ...
    (document.querySelector(".project-description") as HTMLDivElement).innerText = selectedProjectInfo.description;
...
class HomepageProject {
    ...
    constructor(title: string, description: string, pageName: string) {
        this.title = title;
