...
const projects = [
    new Project("Snouty And The Great Rift", "The largest solo project I've ever undertaken! I created a demo for Snouty And The Great Rift from scratch, doing everything from programming to 2D and 3D art to world design and audio. The result is a cute adventure inspired by my love of local woodland walks. Demo available on Steam now!", "pigman", [
    ...
    //     ]
    // ),
    new Project("Sea Of Thieves", "Currently, I work alongside Rare as a Co-Development partner on Sea Of Thieves, the legendary pirate sandbox adventure. I have built and polished many screens of UI in the game, most notably for the Custom Seas feature set.", "sea-of-thieves", [
